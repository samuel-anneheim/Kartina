document.getElementById('validation').addEventListener('click', function() {
    ...
    if (f.password.value == '') {
        f.password.style = "border: 2px solid red";
        console.log('coucou');
    } else {
        f.password.style = "border: 2px solid green";
        i += 1;
    }
    if (f.confirmationPassword.value == '') {
        f.confirmationPassword.style = "border: 2px solid red";
        console.log('coucou');
    } else {
        f.confirmationPassword.style = "border: 2px solid green";
        i += 1;
    }
    if (f.phone.value == '') {
